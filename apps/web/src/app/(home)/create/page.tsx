      ...
      <div className="space-y-6">
        <div className="flex gap-4">
          <div className="flex-1">
            ...
            <input type="text" className="w-full p-2 border bg-gray-200" />
          </div>
        ...
        <div>
          ...
          <textarea className="w-full p-2 border bg-gray-200 h-32 resize-none" />
        </div>
        <div>
        ...
        <div>
          ...
          {/* maybe move this to be side by side with tags */}
          {/* what is this supposed to say? */}
          <p className="text-sm mb-2">
            Upload the TS module containing the component. Ensure that c
          </p>
