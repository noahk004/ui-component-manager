...
import ViewTag from "@/src/components/ViewTag";
            ...
            <div className="flex py-4 pl-4">
                <div className="flex flex-col w-3/4">
                    ...
                    <div className="flex items-center justify-center h-52 w-full bg-gray-200 mt-6 relative">
                        <div className="flex items-center justify-center h-12 w-40 bg-white rounded-full font-bold text-lg">
                            My Button
                        </div>
                    ...
                    <div className="mt-6">
                        ...
                        <pre className="bg-gray-200 p-4 text-sm mt-2">
                            {" "}
                            {/* this formatting is so ugly */}
                            <code>
                                {`// My Component
// Made by user
    ...
    <button>My Button</button>
                ...
                <div className="flex flex-col w-[22.5%] pt-10 ml-8">
                    ...
                    <div className="flex flex-col pb-6 pl-6 border-b-2 border-black">
                        <div className="flex items-center gap-2 mt-4 items-center">
                            {" "}
                            {/*looks offcentered vertically*/}
                    ...
                    <div className="flex flex-col pb-6 pl-4 border-b-2 border-black">
                        {" "}
                        {/*maybe align pl of the divs*/}
